...
--Q1 WRITE THE QUERY TO GET THE LIST OF CUSTOMERS WHERE THEIR ERLIEST PURCHASE WAS AT LEAST 50%

--Q2 WRITE QUERY TO GET NUMBER OF USERS AND TOTAL PRODUCTS BOUGHT PER LATEST TRANSACTION DATE
--WHERE EACH USER IS BUCKETED INTO THEIR LATEST TRANSACTION DATE
